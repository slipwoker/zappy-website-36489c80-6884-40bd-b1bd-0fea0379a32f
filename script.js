document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (value.length < min) {
          error = getFieldLabel(field) + ' must be at least ' + min + ' characters.';
        }
      } else if (field.hasAttribute('maxlength') && value !== '') {
        const max = parseInt(field.getAttribute('maxlength'), 10);
        if (value.length > max) {
          error = getFieldLabel(field) + ' must be no more than ' + max + ' characters.';
        }
      }
  ...
  function clearFormErrors(form) {
    ...
    const existingMsg = form.querySelector('.form-success-message, .form-error-message');
  ...
  function initScrollAnimations() {
    const elements = document.querySelectorAll(
      '.fade-in, [data-animate], .animate-on-scroll, .section-title, .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .hero-content, .about-content, .cta-content'
    );
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "סוחר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '36489c80-6884-40bd-b1bd-0fea0379a32f',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '36489c80-6884-40bd-b1bd-0fea0379a32f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '36489c80-6884-40bd-b1bd-0fea0379a32f';
